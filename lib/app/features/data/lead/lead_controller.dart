...
import 'package:crm_flutter/app/features/screens/lead_&_deal/screens/lead/lead_add_screen_2.dart';
...
class LeadController extends GetxController {
  ...
  Future<void> addLead() async {
    ...
    try {
      ...
      Get.to(LeadAddScreen2());// Optional delay for splash animation
      isLoading(false);
    } catch (e) {
      isLoading(false);
    }
