...
import 'package:crm_flutter/app/features/presentation/screens/lead/screens/lead_overview/screens/lead_overview/features/lead_overview_model_widget.dart';
...
class LeadOverviewModelView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      ...
      final List<LeadOverviewModelWidget> widgets = LeadOverviewModelWidget.getWidgets(lead);
