...
//       deal.assignAll(data.map((e) => DealData.fromJson(e)).toList());
//       return data;
//     } catch (e) {
//       CrmSnackBar.showAwesomeSnackbar(
//         title: 'Error',
...
//         if (index != -1) {
//           deal[index] = DealData.fromJson(dealData);
//           deal.refresh();
//           update();
//         } else {
//           await getDeals();
...
//       final dealData = await dealService.getDealById(dealId);
//       if (dealData != null) {
//         final dealModel = DealData.fromJson(dealData);
...
class DealController extends PaginatedController<DealData> {
  ...
  // Future<void> loadDeals({int page = 1}) async {
  //   try {
  //     isLoading.value = true;
