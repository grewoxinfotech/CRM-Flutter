...
class _SalesInvoiceEditPageState extends State<SalesInvoiceEditPage> {
        ...
        setState(() {
          ...
          if (currencies.isNotEmpty) {
            ...
            if (selectedCurrency != null) {
              ...
              // If the invoice currency is not found, use the first available currency
  ...
  void _initializeControllers() {
    ...
    _currencyCode = 'INR'; // Default
    _currencyIcon = '₹'; // Default

    // We'll update these values once currencies are loaded
  }
  ...
  void _updateCurrencyDetails(String currencyId) {
    ...
    // Fallback to static currencies if API currencies not available or not found
  ...
  void _addProductItem() {
    setState(() {
      // Add a default product_service (first available) instead of null
  ...
  Future<void> _updateInvoice() async {
    if (_formKey.currentState?.validate() ?? false) {
      ...
      final data = {
        ...
        'section': 'sales_functionality-invoice',
