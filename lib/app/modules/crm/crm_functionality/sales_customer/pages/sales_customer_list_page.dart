  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () => Get.toNamed('/sales_functionality-customer/create'),
    ...
    return Card(
      ...
      child: ListTile(
        ...
        trailing: IconButton(
          ...
          onPressed: () => Get.toNamed('/sales_functionality-customer/edit/${customer.id}'),
        ),
        onTap: () => Get.toNamed('/sales_functionality-customer/view/${customer.id}'),
      ),
    );
  }
} 