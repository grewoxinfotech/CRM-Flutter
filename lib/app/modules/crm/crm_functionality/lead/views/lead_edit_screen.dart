...
class _LeadEditScreenState extends State<LeadEditScreen> {
  ...
  void _setLeadData(LeadModel lead) {
    ...
    try {
      ...
      leadController.leadValueController.text =
          lead.leadValue?.toString() ?? '0';
                    ...
                    children: [
                      ...
                      Obx(() {
                        return CrmDropdownField<String>(
                          title: "Stage",
                          value:
                              leadController.selectedStageId.value?.isEmpty ??
                                      true
                                  ? null
                      ...
                      Container(
                        ...
                        child: Obx(
                          () => CrmButton(
                            width: Get.width - 40,
                            title:
                                leadController.isUpdating.value
                                    ? "Updating..."
                                    : "Update Lead",
                            onTap:
                                leadController.isUpdating.value
                                    ? null
                                    : () => _updateLead(leadController),
                            backgroundColor: Get.theme.primaryColor,
  ...
  Future<void> _updateLead(LeadController leadController) async {
    ...
    try {
      ...
      final success = await leadController.updateLead(
        widget.leadId,
        updatedLead,
      );
