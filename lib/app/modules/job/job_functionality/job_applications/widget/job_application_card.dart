...
//
//   JobApplicationCard({Key? key, required this.application}) : super(key: key);
//
//   /// Open CV URL in browser or PDF viewer
...
//
//                       // Status
//                       if (application.status != null && application.status!.isNotEmpty)
//                         Text(
...
//
//                       // Experience
//                       if (application.totalExperience != null)
//                         Text(
...
//
//                       // CV Link
//                       if (application.cvPath != null && application.cvPath!.isNotEmpty)
//                         InkWell(
