...
//
//   OfferLetterCard({Key? key, required this.offerLetter}) : super(key: key);
//
//   @override
...
//                     child: Icon(
//                       Icons.assignment, // Offer letter icon
...
//                       // Candidate Name
//                       Text(
//                         offerLetter.job ?? 'Unnamed Candidate',
...
//
//                       // Job Title
//                       // if (offerLetter.jobTitle != null &&
//                       //     offerLetter.jobTitle!.isNotEmpty)
//                       //   Text(
...
//
//                       // Status
//                       if (offerLetter.status != null)
//                         Text(
//                           "Status: ${offerLetter.status}",
//                           style: TextStyle(
//                             fontSize: 13,
//                             color: offerLetter.status == "Accepted"
//                                 ? Colors.green[700]
...
//                         InkWell(
//                           onTap: () => _openCv(offerLetter.file!),
//                           child: Text(
//                             'View CV',
//                             style: TextStyle(
//                               fontSize: 13,
