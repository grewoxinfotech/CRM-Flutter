...
import 'package:crm_flutter/app/modules/screens/job/views/job_model.dart';
...
class JobScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    List<JobModel> items = JobModel.getCrmWidgets();
    return Scaffold(
      appBar: AppBar(leading: CrmBackButton(), title: Text("Jobs")),
