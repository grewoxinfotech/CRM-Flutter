...
class CustomFormCard extends StatelessWidget {
  ...
  const CustomFormCard({super.key, this.customForm});
      ...
      child: CrmCard(
        ...
        child: Column(
          ...
          children: [
            ...
            /// Event Info
            _infoRow(LucideIcons.calendarClock, "N/A"),
            _infoRow(LucideIcons.mapPin, "N/A"),
            _infoRow(LucideIcons.partyPopper, "N/A"),
          ],
        ),
      ),
    );
