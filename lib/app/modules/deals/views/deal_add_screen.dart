...
class DealAddScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    List textFields = [
      ...
      CrmTextField(title: "Expected Close Date", controller: dealController.closeDate),
      ...
      CrmTextField(title: "Phone Number",controller: dealController.phoneNumber),
      CrmTextField(title: "Company Name",controller: dealController.companyName),
