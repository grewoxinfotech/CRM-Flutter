  ...
  Widget build(BuildContext context) {
    final formFields = <Widget>[
      CrmTextField(
        ...
        title: 'Product Name',
        isRequired: true,
        validator: (v) => requiredValidator(v, 'Please enter product name'),
      ),
      Row(
        children: [
          Expanded(
            child: CrmTextField(
              ...
              isRequired: true,
              validator:
                  (v) => requiredValidator(v, 'Please enter buying price'),
            ),
          ),
          ...
          Expanded(
            child: CrmTextField(
              ...
              isRequired: true,
              validator:
                  (v) => requiredValidator(v, 'Please enter selling price'),
            ),
          ),
        ],
      ),
      ...
      CrmTextField(controller: hsnSacController, title: 'HSN/SAC Code'),
      Row(
        children: [
          Expanded(
            child: CrmTextField(
      ...
      CrmDropdownField<String>(
        ...
        isRequired: true,
        validator: (v) => requiredValidator(v, 'Please select category'),
      ),
      ...
      CrmDropdownField<String>(
        ...
        isRequired: true,
        validator: (v) => requiredValidator(v, 'Please select currency'),
      ),
      CrmDropdownField<String>(
        title: 'Stock Status',
        ...
        isRequired: true,
        validator: (v) => requiredValidator(v, 'Please select stock status'),
      ),
      _buildImagePicker(),
      isLoading
