...
//       appBar: AppBar(title: const Text("Revenue")),
//       body: FutureBuilder(
//         future: controller.loadInitial(), // ✅ only runs once
//         builder: (context, snapshot) {
//           if (snapshot.connectionState == ConnectionState.waiting) {
//             return const Center(child: CrmLoadingCircle());
//           } else if (snapshot.hasError) {
...
//             );
//           } else if (snapshot.connectionState == ConnectionState.done) {
//             // ✅ Once initial load is done, use Obx to listen to items
//             return Obx(() {
...
//                 0.0,
//                     (sum, item) =>
//                 sum + (double.tryParse(item.profit.toString()) ?? 0.0),
//               );
//
//               double profitMargin =
//               totalRevenue != 0 ? (totalProfit / totalRevenue) * 100 : 0;
