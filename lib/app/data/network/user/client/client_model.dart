...
class ClientUserModel {
  ...
  factory ClientUserModel.fromJson(Map<String, dynamic> json) {
    ...
    List<MessageModel> conversationsList = conversationsFromJson != null
        ? conversationsFromJson.map((i) => MessageModel.fromJson(i)).toList()
        : [];
  ...
  Map<String, dynamic> toJson() {
    ...
    conversations.map((message) => message.toJson()).toList();
