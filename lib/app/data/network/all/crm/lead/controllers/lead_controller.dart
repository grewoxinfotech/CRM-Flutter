...
import 'package:crm_flutter/app/data/network/all/crm/label/service/label_service.dart';
...
import 'package:crm_flutter/app/data/network/all/hrm/role/service/roles_service.dart';
import 'package:crm_flutter/app/data/network/all/user_managemant/user/all_user_service.dart';
...
class LeadController extends GetxController {
  ...
  Future<List> getLeads() async {
    try {
      ...
      CrmSnackBar.showAwesomeSnackbar(
        title: 'Error',
        message: 'Failed to fetch lead: ${e.toString()}',
        contentType: ContentType.failure,
      );
      leads.clear();
      return [];
